...
echo "GOOGLE_CLIENT_ID=797265418253-s46ct7402giondpk597t0350kaqkr31p.apps.googleusercontent.com"
echo "GOOGLE_CLIENT_SECRET=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"
